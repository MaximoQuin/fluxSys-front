<template>
  <div class="container mx-auto p-4">
    ...
    <!-- Tabla -->
    <TableComponent :loader="categorySupplierStore.loading" :columns="columns" :data="filteredCategories"
      id="id_category_supplier" :flagRestore="showActive" :currentUserCompany="0" @actionSee="handleSee"
