<template>
  <div class="container mx-auto p-4">
    ...
    <!-- Tabla -->
    <TableComponent :loader="categoryStore.loading" :columns="columns" :data="filteredCategories"
      id="id_category_product" :flagRestore="showActive" :currentUserCompany="0" @actionSee="handleSee"
